...
INSERT INTO `tb_component` (`id`, `name`, `path`, `user_id`, `version`, `visibilitylevel`, `status`, `create_time`, `update_time`, `desc`, `isnew`, `usenumber`) VALUES
	(1, 'truck/image', 'https://ymm-maliang.oss-cn-hangzhou.aliyuncs.com/ymm-maliang/truck/image/0.1.7/index.js', 1, '0.1.7', 1, 1, '2019-01-03 10:40:07', '2019-04-22 07:04:07', '图片', 1, 0),
	(2, 'truck/text', 'https://ymm-maliang.oss-cn-hangzhou.aliyuncs.com/ymm-maliang/truck/text/0.1.7/index.js', 1, '0.1.7', 1, 1, '2018-11-15 05:34:09', '2019-04-22 07:04:07', '文本', 1, 0),
	(3, 'truck/button', 'https://ymm-maliang.oss-cn-hangzhou.aliyuncs.com/ymm-maliang/truck/button/0.1.6/index.js', 1, '0.1.6', 1, 1, '2018-11-15 05:23:00', '2019-04-22 07:04:07', '按钮', 1, 0),
	...
	(10, 'truck/drumPad', 'https://ymm-maliang.oss-cn-hangzhou.aliyuncs.com/ymm-maliang/truck/drumPad/1.0.1/index.js', 1, '1.0.1', 1, 1, '2018-12-27 07:43:39', '2019-04-22 07:05:04', '格子块，n行n列的块状区域，每个块有两个状态', 1, 0);
